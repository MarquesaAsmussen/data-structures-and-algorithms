...
const addOne = (arr) => {
  let emptyArray = [];
  arr.forEach(num => emptyArray.push(num + 1));
  return emptyArray;
  // Solution code here...
};
...
const addExclamation = (arr) => {
  let emptyArray = [];
  arr.forEach(str => emptyArray.push(`${str}!`));
  return emptyArray;
};
...
const allUpperCase = (arr) => {
  let emptyArray = [];
  arr.forEach(str => emptyArray.push(str.toUpperCase()));
  return emptyArray;
};
...
const speaker = (words, callback) => {
  let emptyArray = [];
  words.forEach(word => emptyArray.push(callback(word)));
  return emptyArray;
};
...
const createList = (availableItems) => {
  ...
  availableItems.forEach(availableItem => {
    if (availableItem.available === true) {
      groceryList.push(availableItem.name);
    }
  });
  return groceryList;
};
